...
musicians = Musician.create([{ name: 'Bruce Springsteen', instrument: 0, reputation: 0}, {name: 'Neil Pert', instrument: 1, reputation: 0}, {name: 'Jimmy Page', instrument: 2, reputation: 0}, {name: 'Victor Wooten', instrument: 3, reputation: 0}])
